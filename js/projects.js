...
function pop(t,x,y,cls,sty){const p=document.createElement('div');p.className=cls;p.textContent=t;p.style.left=x+'px';p.style.top=y+'px';if(sty){if(sty.color)p.style.color=sty.color;if(sty.fontSize)p.style.fontSize=sty.fontSize+'px';if(sty.fontFamily)p.style.fontFamily=sty.fontFamily;if(sty.stroke)p.style.webkitTextStroke='2px '+sty.stroke;}document.getElementById('world').appendChild(p);setTimeout(()=>p.remove(),1500)}
